...
class Installer:
    ...
    def build_binary_url(self, version: str, target: str) -> str:
        print(f"https://github.com/aptos-labs/aptos-core/releases/download/aptos-cli-v{version}/aptos-cli-{version}-{target}.zip")
        return f"https://github.com/aptos-labs/aptos-core/releases/download/aptos-cli-v4.6.0/aptos-cli-4.6.0-Ubuntu-x86_64.zip"
